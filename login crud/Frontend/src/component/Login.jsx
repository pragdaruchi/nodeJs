    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <input type="text" onChange={handleChange} value={formdata.password} placeholder="Enter Your Password" name="password" className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
